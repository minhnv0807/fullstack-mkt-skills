...
```mermaid
gantt
    title Content Production Global - Weekly
    dateFormat YYYY-MM-DD
    section Plan
    Calendar Review     :a1, 2026-01-05, 1d
    section Produce
    Skill 04 Script     :b1, after a1, 1d
    Recording Day       :b2, after b1, 1d
    Edit + Skill 05     :b3, after b2, 1d
    section Publish
    QA + Schedule       :c1, after b3, 1d
    Optional UGC Brief  :c2, after c1, 1d
```
