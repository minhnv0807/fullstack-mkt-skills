...
```mermaid
gantt
    title Dropshipping Launch Global - 30 Days
    dateFormat YYYY-MM-DD
    section Research
    Skill 29 Criteria    :a1, 2026-01-01, 2d
    Product Hunt         :a2, after a1, 2d
    Score + Validate     :a3, after a2, 3d
    section Setup
    Shopify Store        :b1, after a3, 2d
    Skill 12 Product Pg  :b2, after b1, 1d
    Sample Test          :b3, after b2, 2d
    Skill 04 + 05 Ads    :b4, after b3, 2d
    section Test
    Launch Ads           :c1, after b4, 2d
    Skill 21 Audit       :c2, after c1, 2d
    New Creative         :c3, after c2, 2d
    Mid-Week Review      :milestone, after c3, 0d
    section Decide
    Scale or Pivot       :d1, after c3, 4d
    Email Flows          :d2, after d1, 2d
    Skill 13 Final       :d3, after d2, 3d
    Decision Locked      :milestone, after d3, 0d
```
